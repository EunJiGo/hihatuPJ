...
class _TransportationScreenState extends ConsumerState<TransportationScreen>
  ...
  Widget build(BuildContext context) {
    ...
    } else if (transportationAsync.hasError) {
      // 에러 UI
      return Center(
        child: Text('에러 발생: ${transportationAsync.error}'),
      );
    } else if (transportationAsync.hasValue) {
    ...
    // 혹시 값도 없고 에러도 아니고 로딩도 아닌 상태 (보통 잘 안나오지만 안전하게)
